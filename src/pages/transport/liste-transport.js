...
export default function ListeTransports() {
            ...
            <Table className={classes.table} aria-label="customized table">
              <TableHead>
                <TableRow>
                  ...
                  <StyledTableCell align="right">Temps</StyledTableCell>
                  ...
                  list
                    ...
                    .map((row) => (
                      <StyledTableRow key={row.name}>
                        ...
                        <StyledTableCell align="right">
                          <Link to={`/update-transport/${row._id}`}>
                            ...
                            onClick={async (event) => {
                              try {
                                let response = await fetch(
                                  `http://localhost:5000/api/transport/${row._id}`,
                                  {
                                    method: "DELETE",
                                    headers: {
                                ...
                                setsuccess("Element bien suprimer");
                              } catch (err) {
                                console.log(err);
